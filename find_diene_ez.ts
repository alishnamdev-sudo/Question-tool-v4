...
console.log(`Searching across ${allQuestions.length} questions for diene E/Z configuration...`);
...
allQuestions.forEach(q => {
  ...
  if (
    comb.includes("diene") && 
    (comb.includes("configuration") || comb.includes("isomer")) &&
    (comb.includes(" e ") || comb.includes(" z ") || comb.includes("(e)") || comb.includes("(z)") || comb.includes("e,z") || comb.includes("e/z"))
  ) {
