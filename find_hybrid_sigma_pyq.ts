...
allQuestions.forEach(q => {
  ...
  if (
    (comb.includes("sp2") || comb.includes("sp3") || comb.includes("hybridization") || comb.includes("hybridized")) &&
    (comb.includes("sigma") && comb.includes("bond")) &&
    (comb.includes("hydrocarbon") || comb.includes("alkene") || comb.includes("diene") || comb.includes("allyl") || comb.includes("vinyl"))
  ) {
    count++;
    console.log(`\nHybrid Match ${count}: [ID: ${q.QuestionId}] [File: ${q.sourceFile}]`);
